...
The PM2.5 emissions dataset contains cleaned particulate matter data that the UK government creates. The original PM15 aerial emission sources have been reporting to the UK government for years, but only the cleaned emissions are included in an integrated dataset for analysis.

The cleaned emissions file has four separate sets of PM2.5 data for each year. There is a row for PM2.5, a row for PM10, a row for PM2.5 emissions, and a row for PM10 emissions in each collection. The single column that estimates PM2.5 emissions in thousands of tonnes will help researchers figure out how this kind of air pollution is related to other kinds of air pollution by showing how changes in the amount of PM2.5 emitted are related to changes in the amount of PM2.5 found in the air.

The PM2.5 and PM10 emissions data will also give us more information about the different kinds of pollution when we compare it to the amount of PM2.5 and PM10 in the air. Researchers will be able to use the data from this dataset to figure out if there is a link between the amount of PM2.5 and PM10 released into the air and the amount of PM2.5 and PM10 found in the air.

This PM2.5 emissions dataset is publicly available from a UK government source and does not contain any identifiable or private individual information; therefore, the only legal and ethical obligations for the datasets are: (1) to cite the source of the dataset; (2) to comply with the terms of reuse; and (3) to limit any overclaims.
